...
for ((j=1; j<$numtrials+1; j=j+1)) do
    ...
    python delaunay_density_diagnostic.py --jobid ${jobid} --seed ${j} --staticdata staticdata/from_ball/parab_exp3/data_paraboloid_10000.csv
    # python delaunay_density_diagnostic.py --jobid ${jobid} --seed ${j} --staticdata staticdata/from_ball/grwk_exp3/data_griewank_1000.csv 
done
