...
for ((j=1; j<$numtrials+1; j=j+1)) do
    ...
    python delaunay_density_diagnostic.py --jobid ${jobid} --seed ${j} --staticdata staticdata/from_ball/grwk_exp3/data_griewank_10000.csv --validsplit 0.005 --initsampprop 0.02 --itmax 4 
